...
if (!class_exists('Taskbot_Dispute')) {
    ...
    class Taskbot_Dispute {
		...
		public function taskbot_dispute_detail_meta($post) {
            ...
            $title                      = esc_html__('View business offer', 'taskbot');
			...
			<ul class="review-info">
                ...
                <li>
                    <span class="push-right">
                        <a target="_blank" href="<?php echo esc_url(get_the_permalink( $linked_employer_profile ));?>"><?php esc_html_e('View owner profile', 'taskbot'); ?></a>
                    </span>
                </li>
