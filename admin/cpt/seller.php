...
/**
 *
 * Class 'Taskbot_Admin_CPT_Owner' defines the cusotm post type
 *
 * @package     Taskbot
...
class Taskbot_Admin_CPT_Seller {
	...
	*/
	public function register_posttype() {
		$labels = array(
			'name'                  => esc_html__( 'Owners', 'taskbot' ),
			'singular_name'         => esc_html__( 'Owners','taskbot' ),
			'menu_name'             => esc_html__( 'Owners', 'taskbot' ),
			'name_admin_bar'        => esc_html__( 'Owners', 'taskbot' ),
			'all_items'             => esc_html__( 'All Owners', 'taskbot' ),
			'add_new_item'          => esc_html__( 'Add new owner', 'taskbot' ),
			'add_new'               => esc_html__( 'Add new owner', 'taskbot' ),
			'new_item'              => esc_html__( 'New owner', 'taskbot' ),
			'edit_item'             => esc_html__( 'Edit owner', 'taskbot' ),
			'update_item'           => esc_html__( 'Update owner', 'taskbot' ),
			'view_item'             => esc_html__( 'View owner', 'taskbot' ),
			'view_items'            => esc_html__( 'View owner', 'taskbot' ),
			'search_items'          => esc_html__( 'Search owner', 'taskbot' ),
		);

		$args = array(
			'label'                 => esc_html__( 'Owners', 'taskbot' ),
			'description'           => esc_html__( 'All owners.', 'taskbot' ),
...
/*  public function taskbot_seller_type_taxonomy_register(){
    $seller_type_labels = array(
      'name' 				=> esc_html__('Owner type', 'taskbot'),
      'singular_name' 		=> esc_html__('Owner type','taskbot'),
      'search_items' 		=> esc_html__('Search owner type', 'taskbot'),
      'all_items' 			=> esc_html__('All owner types', 'taskbot'),
      'parent_item' 		=> esc_html__('Parent owner type', 'taskbot'),
      'parent_item_colon' 	=> esc_html__('Parent owner type:', 'taskbot'),
      'edit_item' 			=> esc_html__('Edit owner type', 'taskbot'),
      'update_item' 		=> esc_html__('Update owner type', 'taskbot'),
      'add_new_item' 		=> esc_html__('Add New owner type', 'taskbot'),
      'new_item_name' 		=> esc_html__('New owner type name', 'taskbot'),
      'menu_name' 			=> esc_html__('Owner type', 'taskbot'),
    );
