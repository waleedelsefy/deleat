...
class Taskbot_Admin_Taxonomies {
	...
	*/
	public function register_custom_taxonomy() {
		...
		register_taxonomy(apply_filters('taskbot_product_taxonomy_languages_name', 'languages'), array('product','sellers','auditors', apply_filters('taskbot_profiles_post_type_name', 'profiles')), apply_filters('taskbot_product_taxonomy_languages', $language_args));
		...
		register_taxonomy(apply_filters('taskbot_product_taxonomy_skills_name', 'skills'), array('product','sellers','auditors', apply_filters('taskbot_profiles_post_type_name', 'profiles')), apply_filters('taskbot_product_taxonomy_skills', $skills_arg));
