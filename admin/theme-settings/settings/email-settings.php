...
Redux::setSection( $opt_name, array(
    ...
    /* Admin Email on Disputes */
		...
		array(
			...
			'desc'    => wp_kses(__( '{{seller_name}} — To display the owner name.<br>
...
Redux::setSection( $opt_name, array(
	'title'			  	=> esc_html__( 'Owner', 'taskbot' ),
	'id'			  	=> 'seller_email_templates',
	'desc'			  	=> 'Owner email templates',
	'icon'			  	=> '',
	'subsection'		=> true,
...
Redux::setSection( $opt_name, array(
	...
	'fields'		=> array(
		...
		/* Project dispute comment by admin to owner & buyer */
		array(
