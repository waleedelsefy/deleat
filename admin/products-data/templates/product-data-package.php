...
<div class="options_group product-data-packages-feilds">
    ...
    woocommerce_wp_text_input( array(
        ...
        'value'         => get_post_meta( get_the_ID(), 'number_tasks_allowed', true ),
            'label'         => esc_html__('Number of Business to post', 'taskbot'),
        'description'   => '',
        'custom_attributes' => array(
            'step' 	=> 'any',
            'min'	=> '0'
    ...
    woocommerce_wp_text_input( array(
        ...
        'label'         => esc_html__('Featured Business', 'taskbot'),
        'description'   => '',
        'custom_attributes' => array(
            'step' 	=> 'any',
            'min'	=> '0'
    ...
    woocommerce_wp_text_input( array(
        ...
        'label'         => esc_html__('Featured business duration(in days)', 'taskbot'),
        'description'   => esc_html__('You can add the Featured Business duration, which means how many days task will be in featured listing', 'taskbot'),
        'desc_tip' => 'true',
        'custom_attributes' => array(
            'step' 	=> 'any',
            'min'	=> '0'
    ...
    woocommerce_wp_checkbox( array(
        ...
        'label'         => esc_html__('Allow Business plans', 'taskbot'),
        'description'   => '',
    ) );
    woocommerce_wp_text_input( array(
