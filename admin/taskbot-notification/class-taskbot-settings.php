        ...
        $list   = array(
            ...
            'submint_task'  => array(
                ...
                'options'   => array(
                    ...
                    'content'           => __('Thank you for submitting the task <strong>“{{task_name}}”</strong>, we will review and approve the business soon.', 'taskbot'),
                    'tags'              => __('
                                            {{task_name}}       — To display the task title.<br>
                                            {{task_link}}       — To display the task link.<br>
                                            {{seller_name}}     — To display the owner name.<br>
                                            {{task_name}}       — To display the task title.<br>
                                            {{email}}    — To display the email address.<br>
                                            {{sitename}} — To display the site name.<br>
                                            '),
            ...
            'task_approved'  => array(
                ...
                'settings'  => array(
                    'image_type'    => 'defult',
                    'tage'          => array('email', 'sitename', 'task_name', 'seller_name', 'task_link'),
                    'btn_settings'  => array('link_type' => 'single_post', 'text' => esc_html__('View Business', 'taskbot'))
                ),
                'options'   => array(
            ...
            // notification to owner for new order
            'seller_new_order'  => array(
                ...
                'options'   => array(
                    'title'             => esc_html__('New order for owner', 'taskbot'),
                    'tag_title'         => esc_html__('Notification setting variables', 'taskbot'),
                    'content_title'     => esc_html__('Notification content', 'taskbot'),
                    'enable_title'      => esc_html__('Enable/disable notification to owner for new order', 'taskbot'),
                    ...
                    'tags'              => __('
                                            ...
                                            {{seller_order_amount}}     — To display the owner amount.<br>
                                            {{seller_order_link}}       — To display the owner order url.<br>
                                            {{sitename}} — To display the site name.<br>
                                            '),
                ),
            ...
            // notification for buyer or owner
            'user_activity'  => array(
                'type'      => 'order',
                'settings'  => array(
            ...
            'order_rejected'  => array(
                ...
                'options'   => array(
                    'title'             => esc_html__('Notification to owner for reject order', 'taskbot'),
                    'tag_title'         => esc_html__('Notification setting variables', 'taskbot'),
                    'content_title'     => esc_html__('Notification content', 'taskbot'),
                    'enable_title'      => esc_html__('Enable/disable notification to owner for reject order', 'taskbot'),
                    'flash_message_title' => esc_html__('Enable/disable flash message', 'taskbot'),
                    'flash_message_option'     => true,
            ...
            'order_completed'  => array(
                ...
                'options'   => array(
                    'title'             => esc_html__('Notification to owner complete order', 'taskbot'),
                    'tag_title'         => esc_html__('Notification setting variables', 'taskbot'),
                    'content_title'     => esc_html__('Notification content', 'taskbot'),
                    'enable_title'      => esc_html__('Enable/disable notification to owner to complete order', 'taskbot'),
                    'flash_message_title' => esc_html__('Enable/disable flash message', 'taskbot'),
                    'flash_message_option'     => true,
            ...
            // notification to owner for dispute
            'refund_request'  => array(
                ...
                'options'   => array(
                    'title'             => esc_html__('Notification to owner for dispute', 'taskbot'),
                    'tag_title'         => esc_html__('Notification setting variables', 'taskbot'),
                    'content_title'     => esc_html__('Notification content', 'taskbot'),
                    'enable_title'      => esc_html__('Enable/disable notification to owner for dispute', 'taskbot'),
                    'flash_message_title' => esc_html__('Enable/disable flash message', 'taskbot'),
                    'flash_message_option'     => true,
            ...
            'refund_decline'  => array(
                ...
                'options'   => array(
                    ...
                    'tags'              => __('
                                            ...
                                            {{task_link}}           — To display the task link.<br>
                                            {{order_id}}            — To display the order id.<br>
                                            {{dispute_comment}}     — To display the owner comments.<br>
                                            {{view_comments}}       — To display the dispute url.<br>
                                            '),
                ),
            ),
            ...
            // notification to owner form admin refunded
            'seller_refunded'  => array(
                ...
                'options'   => array(
                    'title'             => esc_html__('Notification to owner for dispute resolved ', 'taskbot'),
                    'tag_title'         => esc_html__('Notification setting variables', 'taskbot'),
                    'content_title'     => esc_html__('Notification content', 'taskbot'),
            ...
            // notification to owner form admin decline dispute
            'seller_cancelled_refunded'  => array(
                ...
                'options'   => array(
                    'title'             => esc_html__('Notification to owner for dispute in favor of buyer', 'taskbot'),
                    'tag_title'         => esc_html__('Notification setting variables', 'taskbot'),
                    'content_title'     => esc_html__('Notification content', 'taskbot'),
            ...
            'package_purchases'  => array(
                ...
                'settings'  => array(
                    ...
                    'btn_settings'  => array('link_type' => 'single_post', 'text' => esc_html__('List Your Business', 'taskbot'))
                ),
                'options'   => array(
                    ...
                    'flash_message_title'   => esc_html__('Enable/disable flash message', 'taskbot'),
                    'flash_message_option'  => true,
                    'content'           => __('Congratulations! You have successfully purchased the “{{package_name}}” package. You can now post a business and get offers', 'taskbot'),
                    'tags'              => __('
                                            {{seller_name}}         — To display the seller name.<br>
