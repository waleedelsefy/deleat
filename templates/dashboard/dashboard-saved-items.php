					...
					<div class="tb-actionselect tb-actionselect2">
						...
						<div class="tb-select">
							<select id="tb_order_type" name="type" class="form-control tk-selectv">
								<option value="sellers" data-url="<?php echo esc_url($page_url);?>&type=sellers" <?php if( !empty($type) && $type === 'sellers'){ echo do_shortcode('selected');}?>><?php esc_html_e('Owners','taskbot');?></option>
