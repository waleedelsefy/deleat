    ...
    <form id="service-introduction-form" class="tb-themeform" action="<?php echo esc_url($current_page_url);?>" method="post" novalidate enctype="multipart/form-data">
        <fieldset>
            ...
            <div class="form-group form-group-half form-group_vertical">
                <label class="form-group-title"><?php esc_html_e('Add business title:', 'taskbot'); ?></label>
                <input type="text" value="<?php echo esc_attr($service_title); ?>" class="form-control" name="taskbot_service[post_title]" placeholder="<?php esc_attr_e('Enter your business title', 'taskbot'); ?>" autocomplete="off" required="required">
            </div>
            <div class="form-group form-group-half form-group_vertical" id="tb-task-category-level1">
            ...
            <div class="form-group form-group_vertical">
                <label class="form-group-title"><?php esc_html_e('Business introduction', 'taskbot'); ?></label>
