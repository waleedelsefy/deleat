...
$videourl   = '';
$video_name   = '';
$pdfurl = isset( $_POST['pdf_url'] ) ? $_POST['pdf_url'] : '';
    ...
    <form id="service-media-attachments-form" name="service-media-attachments-form" class="tb-themeform service-media-attachments-form" action="<?php echo esc_url($current_page_url);?>" method="post" novalidate enctype="multipart/form-data">
        <fieldset>
            ...
            <div class="form-group">
                <div class="tb-postserviceholder">
                    <div class="tb-postservicetitle">
                        <h4><?php esc_html_e('PDF', 'taskbot');?></h4>
                    </div>
                    <div class="tb-videolink">
                            <input id="pdfurl" name="pdf_url" type="url" autocomplete="off" class="form-control" placeholder="<?php esc_attr_e('Enter PDF link here', 'taskbot');?>" value="<?php echo esc_url($pdfurl);?>">
                             <input type="hidden" id="custom_pdf_upload" name="custom_pdf_upload" value="">
                        <em>
                            <?php esc_html_e('or', 'taskbot');?>
                            <label for="pdffile">
                                <input id="pdffile" type="file" name="pdffile">
                                <?php esc_html_e('upload a PDF', 'taskbot');?>
                            </label>
                        </em>
                    </div>
                </div>
