		...
		<div class="col-lg-12">
			...
			<div class="tb-dhbtabs tb-tasktabs">
				<div class="nav nav-tabs tb-navtabs " id="myTab" role="tablist">
					<a class="nav-link <?php echo esc_attr( $mode == '' or $mode == 'all' ? 'active' : '' );?>" href="<?php echo esc_url(Taskbot_Profile_Menu::taskbot_profile_menu_link($reference, $user_identity, true, 'all'));?>"><?php esc_html_e('All offers','taskbot');?></a>
