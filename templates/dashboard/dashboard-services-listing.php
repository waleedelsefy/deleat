...
<div class="tb-dhb-mainheading">
    <div class="tb-dhb-mainheading__rightarea">
        <em><?php esc_html_e('Add business for each service you offer to increase chances of getting hired', 'taskbot');?></em>
...
<div class="tb-dhb-mainheading">
    <h2><?php esc_html_e('Manage business', 'taskbot');?></h2>
                    ...
                    <div class="tb-itemlinks">
                        ...
                        <?php if($product->get_status() == 'publish' || $product->get_status() == 'private' ){?>
                            <div class="tb-switchservice">
                                <span><?php esc_html_e('Business on / off', 'taskbot');?></span>
                                <div class="tb-onoff">
