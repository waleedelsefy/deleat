...
$auditor_id       = get_post_meta( $order_id, 'auditor_id',true );
$auditor_id       = !empty($auditor_id) ? intval($auditor_id) : 0;
...
$dispute_detail_url	= Taskbot_Profile_Menu::taskbot_profile_menu_link('disputes', $user_identity, true, 'detail');
...
if( !empty($auditor_id) && $auditor_id == $user_identity ){
        ...
        <div class="col-lg-12">
            <div class="tb-orderrequest tb-alert-success">
                <div class="tb-ordertitle">
                    ...
                    <p><?php esc_html_e('The admin has approved your refund request, the amount has been added to your wallet. You can use this amount for your next order', 'taskbot');?></p>
                </div>
                <div class="tb-orderbtn">
                    <a class="tb-btn btn-orange" href="<?php echo esc_url($dispute_detail_url);?>"><?php esc_html_e('View Details', 'taskbot');?></a>
                </div>
        ...
        <div class="col-lg-12">
            <div class="tb-orderrequest tb-orderrequestv2">
                <div class="tb-ordertitle">
                    ...
                    <?php } else {?>
                        <h5><?php esc_html_e('Dispute created', 'taskbot');?></h5>
                        <p><?php esc_html_e('The auditor has created a dispute against that order, admin will review the history of this order and make the final decision', 'taskbot');?></p>
                    <?php } ?>
                </div>
                <div class="tb-orderbtn">
                    <a class="tb-btn btn-orange" href="<?php echo esc_url($dispute_detail_url);?>"><?php esc_html_e('View details', 'taskbot');?></a>
            ...
            <div class="col-lg-12">
                <div class="tb-orderrequest tb-orderrequestv2">
                    <div class="tb-ordertitle">
                        ...
                        <p><?php esc_html_e('The auditor has not replied to your refund request, you can now raise a dispute to acknowledge the admin', 'taskbot');?></p>
                    </div>
                    <div class="tb-orderbtn">
                        <span class="tb-btn btn-orange"  id="taskdisputerequest" data-dispute_id="<?php echo intval($dispute_id); ?>" ><?php esc_html_e('Create dispute', 'taskbot');?></span>
                    </div>
    ...
    <?php } else if(!empty($dispute_status) && $dispute_status === 'declined'){ ?>
        <div class="col-lg-12">
            <div class="tb-orderrequest tb-orderrequestv2">
                <div class="tb-ordertitle">
                    <h5><?php esc_html_e('Refund declined', 'taskbot');?></h5>
                    <p><?php esc_html_e('The auditor has declined your refund request, you can now create the dispute for this order.', 'taskbot');?></p>
                </div>
                <div class="tb-orderbtn">
                    <span class="tb-btn btn-orange"  id="taskdisputerequest" data-dispute_id="<?php echo intval($dispute_id); ?>" ><?php esc_html_e('Create dispute', 'taskbot');?></span>
                </div>
    ...
    <?php } else if(!empty($dispute_status) && $dispute_status === 'refunded'){ 
        ...
        if( !empty($winning_party) && intval($winning_party) === intval($user_identity) ){
            ...
            $resolved_by    = !empty($resolved_by) && $resolved_by === 'auditor' ? esc_html__('auditor','taskbot') : esc_html__('admin','taskbot');
        ?>
        <div class="col-lg-12">
            <div class="tb-orderrequest tb-alert-success">
                <div class="tb-ordertitle">
