...
<div class="tb-insightcontainerv2 tb-auditor-insights tk-dashboard-left">
	<div class="row">
		<div class="col-lg-4">
			<aside class="tb-tabasidebar">
				<div class="tb-asideholder tb-auditor-profile-two">
					<div class="tb-asidebox" id="taskbot-droparea">
						...
						<div class="tb-icondetails">
							...
							<?php do_action( 'taskbot_auditor_hourly_rate_html', $linked_profile );?>
					...
					<?php if( !empty($switch_user) ){?>
						<div class="tb-switchaccount">
							<div class="tb-accouttitle">
								<h5><?php esc_html_e('Login to investor account','taskbot');?></h5>
								<h6><?php esc_html_e('Switching to investor account will take you to your investor account where you can hire auditors','taskbot');?></h6>
							</div>
							<div class="tb-btnarea">
								<a href="javascript:void(0);" class="tb-btn btn-orange tb_switch_user" data-id="<?php echo intval($user_identity);?>"><?php esc_html_e('Switch to investor account','taskbot');?></a>
							</div>
						</div>
					<?php } ?>
				</div>
		...
		<?php } else { ?>
			<div class="col-lg-8">
				<?php taskbot_get_template_part('dashboard/post-project/auditor/dashboard', 'auditor-projects');?>
			</div>
		<?php } ?>
	</div>
</div>
