...
$auditor_dispute_issues      = !empty($taskbot_settings['auditor_dispute_issues']) ? $taskbot_settings['auditor_dispute_issues'] : array();
...
$auditor_shares  = get_post_meta( $order_id, 'auditor_shares', true);
$auditor_shares  = !empty($auditor_shares) ? ($auditor_shares) : 0;
...
<section class="tb-main-section">
    <div class="container">
        <div class="row">
            <?php taskbot_get_template_part('dashboard/dashboard', 'auditors-dispute-notificaton'); ?>
            <div class="col-sm-12 col-lg-8 col-md-12">
                <div class="tb-requestarea">
                    <div class="tb-profile-steps auditor-task-detail">
                                ...
                                <div data-bs-toggle="collapse" data-bs-target="#tb-additionolinfov2" aria-expanded="true"
                                    ...
                                    <div class="tb-additonoltitle">
                                        <div class="tb-startingprice">
                                            ...
                                            <span><?php taskbot_price_format($auditor_shares); ?></span>
                                        </div>
                                ...
                                <div id="tb-additionolinfov2" class="show">
                                    <div class="tb-budgetlist">
                                        ...
                                        <ul class="tb-planslist tb-totalfee">
                                            <li>
                                                <a href="javascript:void(0);">
                                                    <h6><?php esc_html_e('You will get','taskbot');?><span>(<?php taskbot_price_format($auditor_shares); ?>)</span></h6>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                ...
                <input type="hidden" name="task_id" value="<?php echo intval($task_id); ?>">
                    <div class="tb-disputelist">
                        <ul class="tb-radiolist">
                            <?php if (!empty($auditor_dispute_issues)) {
                                foreach ($auditor_dispute_issues as $key => $issue) { ?>
                                    <li>
                                        <div class="tb-radio">
                    ...
                    <div class="tb-popupbtnarea">
                        ...
                        <a href="javascript:void(0);" id="auditor-request-submit" class="tb-btn"><?php esc_html_e('Submit', 'taskbot'); ?> <span class="rippleholder tb-jsripple"><em class="ripplecircle"></em></span></a>
                    </div>
                </form>
            </div>
        </div>
