						...
						<?php if (class_exists('WooCommerce')) {?>
							<div class="form-group-half form-group_vertical">
								...
								<span class="tb-select">
									<select id="category" name="billing[billing_country]" data-placeholderinput="<?php esc_attr_e('Search country', 'taskbot'); ?>" data-placeholder="<?php esc_attr_e('Choose country', 'taskbot'); ?>">
