					...
					<?php if( !empty($switch_user) ){?>
						<div class="tb-switchaccount tb-buyeraccount">
							...
							<div class="tb-btnarea">
								<a href="javascript:void(0);" class="tb-btn btn-purple tb_switch_user" data-id="<?php echo intval($user_identity);?>"><?php esc_html_e('Switch to owner account','taskbot');?></a>
							</div>
						</div>
					<?php } ?>
				</div>
