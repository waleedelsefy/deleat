...
$terms_conditions_URL   = !empty( $taskbot_settings['tpl_terms_conditions'] ) ? get_the_permalink($taskbot_settings['tpl_terms_conditions']) : '';
    ...
    <div class="tb-asideholder tb-asideholdertwo">
        ...
        <div class="tb-asidebox">
            <div class="tb-payoutmethodholder">
                ...
                <div class="tb-paymetdesc">
                    <p>
                        <em><?php esc_html_e('Choose any payment method to receive your earned amount direct to your desired account. Leaving this empty or unchecked will cause delay or no payments. For further info read our details.', 'taskbot'); ?>
                        <a href="<?php echo esc_url($terms_conditions_URL);?>" target="_blank"><?php esc_html_e('Transfer & usage policy.', 'taskbot') ?></a></em>
                    </p>
                </div>
            </div>
        </div>
