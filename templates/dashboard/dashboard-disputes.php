						...
						<fieldset>
							<div class="tb-themeform__wrap">
								<div class="form-group wo-inputicon wo-inputheight">
									...
									<input type="text" id="dispute-search" name="search" value="<?php echo esc_attr($search);?>" class="form-control" placeholder="<?php esc_attr_e('Search business here', 'taskbot');?>">
								</div>
