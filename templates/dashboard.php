                            ...
                            if ( !empty($reference) && $reference === 'cart' && $user_type === 'buyers') {
                                ...
                                if ( !empty($app_task_base) && !empty($reference) && !empty($mode) && $reference === 'task' && $mode === 'listing' && $user_type !== 'buyers') {
                                    ...
                                    if( !empty($user_type) && $user_type === 'buyers' ){
                                        ...
                                        if( !empty($mode) && $mode === 'listing' ){
                                            taskbot_get_template_part('dashboard/post-project/auditor/dashboard', 'auditor-projects');
                                        }else if( !empty($mode) && $mode === 'activity'){
                                            taskbot_get_template_part('dashboard/post-project/auditor/dashboard', 'proposals-activity');
                                        }
                                    }
                                ...
                                }else if ( !empty($reference) && $reference === 'earnings' && $user_type !== 'buyers' ) {
