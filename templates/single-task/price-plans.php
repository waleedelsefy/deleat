                    ...
                    <li>
                        <div class="tb-packages__content">
                            ...
                            <div class="tb-packages__buy">                                    
                                <a href="javascript:void(0);" data-url="<?php echo esc_url( $cart_url );?>" data-type="task_cart" class="tb-btn <?php echo esc_attr($checkout_class);?>"><?php esc_html_e('Request now', 'taskbot'); ?></a>
                            </div>
                        </div>
                    </li>
                <?php } ?>
