						...
						<div class="tb-radiodispute">
							<div class="tb-radiolist payoutlists">
								<span class="tb-wininginfomain">
									...
									<span class="tb-wininginfo">
										<em><?php esc_html_e('Owner', 'taskbot');?></em>
					...
					<fieldset>
						<div class="form-group-wrap">
							...
							<div class="form-group tb-dbtnarea tb-dbtnarea-row">
								<a href="javascript:void(0);" class="tb-btn project-resolve-dispute-btn"  data-proposal_id="<?php echo intval($proposal_id); ?>" data-buyer-id="<?php echo esc_attr($buyer_id); ?>" data-seller-id="<?php echo esc_attr($seller_id); ?>" data-dispute-id="<?php echo esc_attr($dispute_id); ?>"><?php esc_html_e('Submit', 'taskbot');?><span class="rippleholder tb-jsripple"><em class="ripplecircle"></em></span></a>
	...
	<div class="tb-disputearea-wrapper">
		<div class="tb-dbholder">
			...
			<div class="tb-dbbox">
				...
				<?php if($dispute_resolve_status !== 'resolved'){?>
					<form class="tb-themeform tb-refundform_form" id="project-dispute-reply-form">
						...
						<div class="tb-disputebtn">
							<a href="javascript:void(0);" id="project-dispute-reply-btn" class="tb-btn"><?php esc_html_e('Submit', 'taskbot'); ?><span class="rippleholder tb-jsripple"><em class="ripplecircle"></em></span></a>
