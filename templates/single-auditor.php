        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-xl-4">
                    <aside class="tb-tabasidebar tb-single-auditor">
                        <div class="tb-asideholder">
                            <?php taskbot_get_template( 'single-auditor/profile-basic.php',$taskbot_args);?>
                            <?php if( !empty($skills) ){ ?>
                                <div class="tb-asidebox tb-freelancerinfo tb-auditor-skills">
                            ...
                            <?php } ?>
                            <?php taskbot_get_template( 'single-auditor/profile-education.php',$taskbot_args);?>
                        </div>
                    </aside>
                </div>
                <?php if( !empty($app_task_base) ){?>
                    <div class="col-lg-7 col-xl-8">
                        <div class="tb-sort tb-auditorsort">
                            <h3><?php esc_html_e('Offered Business','taskbot');?></h3>
                        </div>
                        <?php taskbot_get_template( 'single-auditor/profile-services.php',$taskbot_args);?>
                    </div>
                <?php } else { ?>
                    <div class="col-lg-8">
                        <div class="tb-sort">
                        ...
                        <?php taskbot_get_template( 'single-auditor/profile-completed-projects.php',$taskbot_args);?>
                    </div>
                <?php } ?>
            </div>
        </div>
