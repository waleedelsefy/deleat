        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-xl-4">
                    <aside class="tb-tabasidebar tb-single-buyer">
                        <div class="tb-asideholder">
                            <?php taskbot_get_template( 'single-buyer/profile-basic.php',$taskbot_args);?>
                            <?php if( !empty($skills) ){ ?>
                                <div class="tb-asidebox tb-freelancerinfo tb-buyer-skills">
                            ...
                            <?php } ?>
                            <?php taskbot_get_template( 'single-buyer/profile-education.php',$taskbot_args);?>
                        </div>
                    </aside>
                </div>
                <?php if( !empty($app_task_base) ){?>
                    <div class="col-lg-7 col-xl-8">
                        <div class="tb-sort tb-buyersort">
                            <h3><?php esc_html_e('Offered Business','taskbot');?></h3>
                        </div>
                        <?php taskbot_get_template( 'single-buyer/profile-services.php',$taskbot_args);?>
                    </div>
                <?php } else { ?>
                    <div class="col-lg-8">
                        <div class="tb-sort">
                        ...
                        <?php taskbot_get_template( 'single-buyer/profile-completed-projects.php',$taskbot_args);?>
                    </div>
                <?php } ?>
            </div>
        </div>
