...
if (!class_exists('TaskbotPackagesStatuses')) {
  class TaskbotPackagesStatuses extends Taskbot_Email_helper
  {
    ...
    public function package_purchase_seller_email($params = '')
    {
      ...
      $contact_default 	        = wp_kses(__('Thank you for purchasing the package “{{package_name}}” <br/> You can now post a business and get offers', 'taskbot'), //default email content
        array(
          'a' => array(
            'href' => array(),
            'title' => array()
