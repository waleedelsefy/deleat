    ...
    public function enqueue_scripts() {
        ...
        if( !is_page_template( 'templates/admin-dashboard.php') ) {
            ...
            $data = array(
                ...
                'service_type'                  => esc_html__('Business type', 'taskbot'),
                ...
                'user_type'                     => $user_type,
                'login_required'                => esc_html__('You must login as buyer to send a message to this owner','taskbot'),
                ...
                'seller_skills_option'          => esc_html__('Select owner skills from the list', 'taskbot'),
                ...
                'login_seller_required'         => esc_html__('You must login as owner to access this option','taskbot'),
                'login_required_apply'          => esc_html__('You must login as owner to apply on this project','taskbot'),
