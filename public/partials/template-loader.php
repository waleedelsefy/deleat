    ...
    class Taskbot_PageTemplaterLoader {
        ...
        private function __construct() {
            ...
            $this->templates = array(
                ...
                'templates/search-task.php' 	        => esc_html__('Search business','taskbot'),
                ...
                'templates/search-freelancer.php' 	    => esc_html__('Search owners','taskbot'),
                'templates/search-auditor.php' 	        => esc_html__('Search auditor','taskbot'),
                'templates/search-buyer.php' 	        => esc_html__('Search Investors','taskbot'),
